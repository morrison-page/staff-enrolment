...
const handleSubmit = async () => {
  if (formRef.value.checkValidity() === false || user.password !== matchingPassword.value) {
      ...
      <form ref="formRef" @submit.prevent="handleSubmit" novalidate>
        ...
        <div v-if="!isEditMode" class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Please provide a password (8-50 characters).</div>
          </div>
          <div class="col-md-6 mb-4">
            <label for="password-check" class="form-label">Password Again</label>
            <input v-model="matchingPassword" id="password-check" type="password" class="form-control" required minlength="8" maxlength="50"/>
