    ...
    <div class="card p-4 mt-5">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="mb-3">
          ...
          <input v-model="course.course_title" id="course_title" type="text" class="form-control" required/>
        </div>
        <div class="mb-3">
          <label for="course_date" class="form-label">Course Date</label>
          <input v-model="course.course_date" id="course_date" type="date" class="form-control" required/>
        </div>
        <div class="mb-3">
          <label for="course_duration" class="form-label">Course Duration (days)</label>
          <input v-model="course.course_duration" id="course_duration" type="number" class="form-control" required/>
        </div>
        <div class="mb-3">
          <label for="max_attendees" class="form-label">Max Attendees</label>
          <input v-model="course.max_attendees" id="max_attendees" type="number" class="form-control" required/>
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">Description</label>
            <textarea v-model="course.description" style="max-height: 200px;" id="description" class="form-control" required></textarea>
        </div>
